...
if testCount == nil then
  if not enigma then
    ...
    enigma:FindAbilityByName("minerals_dummy_unit"):SetLevel(1)
    ...
    planet1:FindAbilityByName("minerals_dummy_unit"):SetLevel(1)
    ...
    planet2:FindAbilityByName("minerals_dummy_unit"):SetLevel(1)
    ...
    planet3:FindAbilityByName("minerals_dummy_unit"):SetLevel(1)
...
if testCount == 0 then
  ...
  --[[for i=1,4 do
    ...
    --units[i]:FindAbilityByName("minerals_dummy_unit"):SetLevel(1)
...
if testCount == 3 then
  ...
  Timers:CreateTimer("timer", {
    callback = function()
      ...
      unit:FindAbilityByName("minerals_dummy_unit"):SetLevel(1)
