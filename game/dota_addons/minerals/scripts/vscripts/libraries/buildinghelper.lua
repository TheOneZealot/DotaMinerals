...
function BuildingHelper:PlaceBuilding(player, name, location, construction_size, pathing_size, angle, team)
    --[[ Changed was previously the following:
    ...
    local teamID = team or playersHero:GetTeamNumber()
    ...
    -- Spawn the building
    local building = CreateUnitByName(name, model_location, false, playersHero, player, teamID)
