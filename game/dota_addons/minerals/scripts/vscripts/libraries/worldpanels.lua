...
--[[
  ...
  -Ensure that you have the minerals_worldpanels.xml in your panorama content layout folder.
  -Ensure that you have the minerals_worldpanels.js in your panorama content scripts folder.
  -Ensure that minerals_worldpanels.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/minerals_worldpanels.xml" />
