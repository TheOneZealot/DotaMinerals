...
--[[
  ...
  -Ensure that you have the minerals_attachments.xml, minerals_attachments.js, and minerals_attachments.css files in your panorama content folder to use the GUI.
  -Ensure that minerals_attachments.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/minerals_attachments.xml" />
