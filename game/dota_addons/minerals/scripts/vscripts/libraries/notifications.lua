...
--[[
  ...
  -Ensure that you have the minerals_notifications.xml, minerals_notifications.js, and minerals_notifications.css files in your panorama content folder.
  -Ensure that minerals_notifications.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/minerals_notifications.xml" />
