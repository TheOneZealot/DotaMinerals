...
--[[
  ...
  See Minerals:PostLoadPrecache() in minerals.lua for more information
  ]]

  DebugPrint("[MINERALS] Performing pre-load precache")
  ...
  PrecacheUnitByNameSync("minerals_building_rocks", context)
end

-- Create the game mode when we activate
function Activate()
  GameRules.Minerals = Minerals()
  GameRules.Minerals:_InitMinerals()
end
